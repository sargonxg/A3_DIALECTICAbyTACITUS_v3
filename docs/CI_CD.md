...
Future CI should add byte-for-byte generated-fixture comparison once the
compiler output is promoted from local fixture mode to the canonical checked-in
golden package.
